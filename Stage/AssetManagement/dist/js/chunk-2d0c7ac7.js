  ...
  return _c('section', [_c('loader', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, [_vm._v(" Inactive ")]) : data.row.StatusName == 'Asset Requisition Cancelled By Assigner' || 'Asset Requisition Cancelled By User' ? _c('span', {
          staticClass: "px-2 bg-danger text-center text-white d-block"
        }, [_vm._v(" Rejected ")]) : _c('span', {
          staticClass: "px-2 bg-success text-center text-white d-block"
        }, [_vm._v(" Assigned ")])] : _vm._e(), data.column.COLUMN_NAME == 'Reject' ? [data.row.StatusName == 'Asset Requisition Cancelled By Assigner' ? _c('span') : _c('span', {
        ...
        })])])] : _vm._e(), data.column.COLUMN_NAME == 'CreatedAt' ? [_c('span', [_vm._v(_vm._s(_vm.$options.filters.formatDateTime(data.row.CreatedAt)))])] : _vm._e(), data.column.COLUMN_NAME == 'FromTime' ? [_c('span', [_vm._v(_vm._s(_vm.$options.filters.formatDateTime(data.row.FromTime)))])] : _vm._e(), data.column.COLUMN_NAME == 'ToTime' ? [_c('span', [_vm._v(_vm._s(_vm.$options.filters.formatDateTime(data.row.ToTime)))])] : _vm._e(), data.column.COLUMN_NAME == 'ModifiedAt' ? [_c('span', [_vm._v(_vm._s(_vm.$options.filters.formatDateTime(data.row.ModifiedAt)))])] : _vm._e(), data.column.COLUMN_NAME == 'Assigned' ? [data.row.IsAssigned ? _c('span', [_vm._v("Yes")]) : data.row.StatusName == 'Asset Requisition Cancelled By Assigner' ? _c('span', [_vm._v("Unassigned ")]) : _c('span', [_vm._v("Pending")])] : _vm._e()];
      }
    }])
...
// CONCATENATED MODULE: ./src/views/AssetRequisition/MyRequisitionsList.vue?vue&type=template&id=d87ba652&
...
function bindleftCommonSearchdropdown(instance, modulename, filtername) {
  ...
  if (filtername == "Product_Name") {
    DataService["a" /* default */].GetAssetType().then(response => {
...
/* harmony default export */ var MyRequisitionsListvue_type_script_lang_js_ = ({
  ...
  created() {
    var vm = this;
    MyRequisitionsListSchema.bindleftCommonSearchdropdown(vm, 'AssetRequisition', 'Product_Name');
    MyRequisitionsListSchema.bindleftCommonSearchdropdown(vm, 'AssetRequisition', 'Unique Name');
    debugger;
    vm.FetchData();
    this.LegendArray = [{
