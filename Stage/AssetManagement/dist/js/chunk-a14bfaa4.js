(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-a14bfaa4"],{
...
// load the styles
var content = __webpack_require__("bff4");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("ecd20a66", content, true, {"sourceMap":false,"shadowMode":false});
...
var render = function render() {
  ...
  return _c('section', {
    ...
    on: {
      "quotes": _vm.quotes,
      "quoteItemDelete": _vm.quoteItemDelete
    }
  })], 1), _c('OnlinePurchase', {
    on: {
      "purchases": _vm.purchases,
      "purchaseDeleteItem": _vm.purchaseDeleteItem,
      "purchaseLinkDeleteItem": _vm.purchaseLinkDeleteItem
    }
  }), _c('div', {
...
// CONCATENATED MODULE: ./src/views/AssetRequisition/AddNewRequisition.vue?vue&type=template&id=df266916&scoped=true&

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.push.js
var es_array_push = __webpack_require__("14d9");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"b069f33e-vue-loader-template"}!./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/views/AssetRequisition/AddQuotes.vue?vue&type=template&id=4e0df4e0&
var AddQuotesvue_type_template_id_4e0df4e0_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('section', [_c('loader', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function ($event) {
          return _vm.removeRow(item.count, item);
        }
      }
    }, [_c('i', {
...
var AddQuotesvue_type_template_id_4e0df4e0_staticRenderFns = [];

// CONCATENATED MODULE: ./src/views/AssetRequisition/AddQuotes.vue?vue&type=template&id=4e0df4e0&
  ...
  async created() {
    ...
    if (this.$route.params.reqForm == 'ProductTypeList') {
      ...
      if (this.productItem != null && this.productItem != '' && this.productItem != 'undefined') {
        // debugger         
        await vm.UpdateRequisition(this.productItem.AssetRequisitionId);
      }
    }
  },
  methods: {
    UpdateRequisition: async function (id) {
      try {
        ...
        vm.isLoading = true;
        var params = `id=${id}`;
        // Use await with try-catch block for asynchronous call
        var response = await DataService["a" /* default */].UpdateRequisition(params);
        if (response.data != null) {
          vm.newDynamicField = [];
          vm.quoteData = JSON.parse(response.data.QuoteNewRequisitionList);
          // Simplified logic for counting elements
          vm.quoteData.forEach((element, index) => {
            element.count = index + 1;
          });
          vm.quoteData.forEach(value => {
            var obj = {
            ...
            let pushobj = {
              quoteId: value.quoteId,
              quoteVendor: value.vendorId,
              quoteQuantity: value.quantity,
              quoteAmount: value.currencyId,
              quotePrice: value.price,
              quoteTotalPrice: value.totalPrice,
              uploadQuote: value.quote,
              fileName: value.quote_file_name
            };
            vm.$emit('quotes', pushobj);
          });
          vm.isLoading = false;
        }
      } catch (error) {
    ...
    handleVendorChange() {
      ...
      console.log("Vendor value changed:", this.item.getVenderValue);
    },
    ...
    async getVendorlist() {
      await DataService["a" /* default */].GetCrmVendor().then(response => {
        if (response.data != null) {
    ...
    async getCurrencylist() {
      await DataService["a" /* default */].GetCurrency().then(response => {
        if (response.data != null) {
    ...
    removeRow(id, item) {
      var vm = this;
      const index = vm.newDynamicField.findIndex(x => x.count === id);
      if (index !== -1) {
        vm.newDynamicField.splice(index, 1);
        vm.$emit('quoteItemDelete', item);
      }
      return true;
    }
  }
...
var AddQuotes_component = Object(componentNormalizer["a" /* default */])(
  ...
  AddQuotesvue_type_template_id_4e0df4e0_render,
  AddQuotesvue_type_template_id_4e0df4e0_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"b069f33e-vue-loader-template"}!./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/views/AssetRequisition/OnlinePurchase.vue?vue&type=template&id=73427415&
var OnlinePurchasevue_type_template_id_73427415_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "col-lg-12 mt-3 px-0"
...
var OnlinePurchasevue_type_template_id_73427415_staticRenderFns = [];

// CONCATENATED MODULE: ./src/views/AssetRequisition/OnlinePurchase.vue?vue&type=template&id=73427415&
...
/* harmony default export */ var OnlinePurchasevue_type_script_lang_js_ = ({
  ...
  methods: {
    UpdateRequisition: async function (id) {
      ...
      vm.isLoading = true;
      try {
        const response = await DataService["a" /* default */].UpdateRequisition(`id=${id}`);
        if (response.data !== null) {
          vm.newDynamicField = [];
          vm.purchaseEditField = [];
          vm.purchaseEditFieldsData = JSON.parse(response.data.PurchaseNewRequisitionList);
          vm.purchaseEditFieldsData.forEach((element, index) => {
            element.count = index + 1;
            var linksArray = JSON.parse(element.links);
            let purchaseEditFieldArray = [];
            linksArray.forEach((link, indx) => {
              let obj = {
                purchase_link_id: link.purchaseLinkId,
                purchase_link: link.purchaseLink,
                pcount: indx + 1
              };
              purchaseEditFieldArray.push(obj);
            });
            element.purchaseDynamicField = purchaseEditFieldArray;
          });
          vm.purchaseEditFieldsData.forEach(value => {
            var obj = {
              purchase_id: 0,
              purchase_vendor: '',
              txtpurchaseQuantity: '',
            ...
            obj.purchaseDynamicField = value.purchaseDynamicField;
            obj.count = value.count;
            vm.newDynamicField.push(obj);
            value.purchaseDynamicField.forEach(ele => {
              vm.Pushlink.push({
                purchase_link_id: ele.purchase_link_id,
                purchase_link: ele.purchase_link
              });
            });
            let pushObj = {
              purchase_id: value.purchaseId,
              purchase_vendor: value.vendorId,
              purchaseQuantity: value.quantity,
              purchasePrice: value.currencyId,
              ppriceAmount: value.totalPrice,
              purchaseTotalPrice: value.totalPrice,
              purchaselinks: vm.Pushlink
            };
            vm.$emit('purchases', pushObj);
            vm.isVisible = true;
          });
          vm.isLoading = false;
        }
    ...
    calculateTotalQuantity(item) {
      ...
      if (getRecordInformation != null) {
        let pushLinks = [];
        getRecordInformation.purchaseDynamicField.map(ele => {
          let obj = {
            purchase_link_id: ele.purchase_link_id,
            purchase_link: ele.purchase_link
          };
        ...
        vm.purchaseData = {
          purchase_id: getRecordInformation.purchase_id ? getRecordInformation.purchase_id : 0,
    ...
    removeRow(item, purchase) {
      ...
      vm.newDynamicField.forEach(element => item.purchaseDynamicField.forEach((subItem, index) => {
        if (element.count == newDynamicArrayCount) {
          if (element.purchaseDynamicField.length === 1) {
            const index = vm.newDynamicField.findIndex(x => x.count === newDynamicArrayCount);
            if (index !== -1) {
              vm.newDynamicField.splice(index, 1);
              vm.$emit('purchaseDeleteItem', item);
              return;
            }
          } else if (subItem.pcount === purchase.pcount) {
            element.purchaseDynamicField.splice(index, 1);
            vm.$emit('purchaseLinkDeleteItem', element);
            return;
          }
        } else {
          //
...
var OnlinePurchase_component = Object(componentNormalizer["a" /* default */])(
  ...
  OnlinePurchasevue_type_template_id_73427415_render,
  OnlinePurchasevue_type_template_id_73427415_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var AddNewRequisitionvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    quoteItemDelete: function (quoteItemDelete) {
      debugger;
      var vm = this;
      const index = vm.qoutesArray.findIndex(x => x.quoteVendor == quoteItemDelete.getVenderValue);
      if (index !== -1) {
    ...
    purchaseLinkDeleteItem(item) {
      var vm = this;
      const getRecordInformation = vm.purchaseArray.find(x => x.purchase_vendor == item.purchase_vendor);
      if (getRecordInformation != null) {
        let pushLinks = [];
        item.purchaseDynamicField.map(ele => {
          let obj = {
            purchase_link_id: ele.purchase_link_id,
            purchase_link: ele.purchase_link
          };
        ...
        let obj = {
          ...
          purchaseQuantity: item.txtpurchaseQuantity,
          purchasePrice: item.getCurrencyValue,
          ppriceAmount: item.priceAmount,
          purchaseTotalPrice: item.purchasePrice,
          purchaselinks: pushLinks
        };
        const index = vm.purchaseArray.findIndex(x => x.purchase_vendor == item.purchase_vendor);
        if (index !== -1) {
          vm.purchaseArray.splice(index, 1);
        }
        vm.purchaseArray.push(obj);
      }
      console.log("vm.purchaseArray", vm.purchaseArray);
    },
    purchaseDeleteItem(purchases) {
      debugger;
      var vm = this;
...
// EXTERNAL MODULE: ./src/views/AssetRequisition/AddNewRequisition.vue?vue&type=style&index=0&id=df266916&prod&scoped=true&lang=css&
var AddNewRequisitionvue_type_style_index_0_id_df266916_prod_scoped_true_lang_css_ = __webpack_require__("f437");
...
// Module
exports.push([module.i, ".vue-treeselect__control[data-v-df266916]{border:none;height:24px;padding:0}.vue-treeselect--searchable .vue-treeselect__input-container[data-v-df266916]{padding:0!important}.vue-treeselect__placeholder[data-v-df266916]{color:#303030!important}.vue-treeselect__control-arrow[data-v-df266916]{color:#000}.vue-treeselect__placeholder[data-v-df266916]{line-height:24px}", ""]);
// Exports
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddNewRequisition_vue_vue_type_style_index_0_id_df266916_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("0936");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddNewRequisition_vue_vue_type_style_index_0_id_df266916_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddNewRequisition_vue_vue_type_style_index_0_id_df266916_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
