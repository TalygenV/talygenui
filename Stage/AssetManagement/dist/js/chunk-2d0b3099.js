...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t('RFIDCheckinItems')))])])])])])])])])]), _c('tg-list', {
    attrs: {
      "IsShowAction": false,
      "SearchPosition": "none",
      "listType": ['List'],
...
/* harmony default export */ var ReturnItemsvue_type_script_lang_js_ = ({
  ...
  methods: {
    async GetReturnList(ths) {
      ...
      const url = `chekedInId=${this.chekedInId}&search=${this.search}&pagenumber=${this.pagenumber}&pageSize=${this.pageSize}&sortBy=${this.sortBy}&sortExp=${this.sortExp}`;
      var vueObj = this;
