(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-3b143901"],{
...
var render = function render() {
  ...
  return _c('section', [_c('loader', {
  ...
  })]), _vm.popupCondition == 'setup' ? _c('h4', {
    staticClass: "modal-title",
    attrs: {
      "id": "conditionalTitle"
    }
  }, [_vm._v(_vm._s(_vm.$t("Setup")) + " ")]) : _c('h4', {
    staticClass: "modal-title",
    attrs: {
      "id": "conditionalTitle"
    }
  }, [_vm._v(_vm._s(_vm.$t("AddItem")))]), _vm.popupCondition != 'setup' ? _c('span', {
    ...
    key: _vm.refreshComponent,
    attrs: {
      "popupCondition": _vm.popupCondition
    },
    on: {
      "RefresComp": _vm.RefresComp
    }
...
// CONCATENATED MODULE: ./src/components/Modal/AddProduct.vue?vue&type=template&id=24bfd57f&
...
var AddLocationvue_type_template_id_5d638a0c_lang_en_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "border p-3"
...
var AddLocationvue_type_template_id_5d638a0c_lang_en_staticRenderFns = [];
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  AddLocationvue_type_template_id_5d638a0c_lang_en_render,
  AddLocationvue_type_template_id_5d638a0c_lang_en_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var AddProductvue_type_script_lang_js_ = ({
  ...
  methods: {
        ...
        DataService["a" /* default */].AddAssetWizard(formData).then(function (response) {
          if (val == 'SaveAndClose') {
            ...
            if (response.data.msg == "size_exceed" || response.data.msg == "FileSizeExceeded" || response.data.msg == "ExceedAllowedSize") {
              ...
              vm.ShowAlert(vm.$t("Already exist record!"), "warning", vm.$t('Alert'));
              vm.buttons[2].class = vm.buttons[2].class.replace("disabled", "").trim();
            } else if (response.data.msg == 'ValidFileUploadMsg') {
              vm.ShowAlert(vm.$t("Please upload valid file!"), "warning", vm.$t('Alert'));
            } else if (response.data.msg == 'add') {
              if (vm.popupCondition == 'setup') {
    ...
    resetForm() {
      this.FormSchema.forEach(group => {
        group.Data.forEach(field => {
          if (field.astype === 'SelectField' || field.astype === 'RadioField') {
            field.value = '';
          } else if (field.astype === 'TextField') {
            field.value = '';
          } else if (field.astype === 'NumericField') {
            field.value = '0';
          } else if (field.astype === 'MultiSelectField') {
            field.value = [];
          } else if (field.astype === 'TreeSelectField') {
            field.value = null;
          } else if (field.astype === 'ToggleField') {
            field.value = false;
          } else if (field.astype === 'FileField') {
            field.value = '';
          } else if (field.astype === 'SlotField') {
            field.value = '';
          }
        });
      });
    ...
    GetAssetType() {
      ...
      DataService["a" /* default */].GetAssetTypeCustom(url).then(response => {
        ...
        vm.isLoading = false;
        vm.$refs.modalAddCustomForm.UpdateKeyValue();
      });
...
// EXTERNAL MODULE: ./src/components/Modal/AddProduct.vue?vue&type=style&index=0&id=24bfd57f&prod&lang=css&
var AddProductvue_type_style_index_0_id_24bfd57f_prod_lang_css_ = __webpack_require__("e058");
...
// load the styles
var content = __webpack_require__("5e59");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("da783e02", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddProduct_vue_vue_type_style_index_0_id_24bfd57f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("b595");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddProduct_vue_vue_type_style_index_0_id_24bfd57f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddProduct_vue_vue_type_style_index_0_id_24bfd57f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__);
