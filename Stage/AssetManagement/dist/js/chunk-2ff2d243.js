(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-2ff2d243"],{
...
var render = function render() {
  ...
  return _c('section', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('ProductsGroupList')))]), _c('span', {
    ...
    on: {
      "click": function ($event) {
        return _vm.AddNewGroup(0);
      }
    }
  }, [_c('em', {
    staticClass: "fa fa-plus"
  }), _c('br'), _vm._v(_vm._s(_vm.$t('AddNew')))]), _c('em', {
    staticClass: "table-head-btn p-action-btn text-white disabled iconenable",
    attrs: {
      "title": "DeleteAssetCatalogue",
      "id": "DeleteAssetCatalogue"
    },
    on: {
      "click": function ($event) {
        return _vm.DeleteRFID();
      }
    }
  }, [_c('em', {
    staticClass: "fa fa-trash"
  }), _c('br'), _vm._v(_vm._s(_vm.$t('Delete')) + " ")])])])]), _c('div', {
    staticClass: "col-sm-12 col-md-12 col-lg-12 col-xl-12 searchpanel tablehead search float-left p-0"
  }, [_c('div', {
    staticClass: "col-sm-12 col-md-12 col-lg-12 col-xl-12 pt-2 p-0"
  }, [_c('div', {
    ...
    staticClass: "search-btm-btn background-0 text-left m-0"
  }, [_c('em', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('GroupName')))])]), _c('th', [_c('span', {
    staticClass: "sort",
    attrs: {
      "href": "javascript:;",
      "id": "GroupDetails"
  ...
  }, [_vm._v(_vm._s(_vm.$t('Detail')))])]), _c('th', [_c('span', {
    attrs: {
      "href": "javascript:;",
      "id": ""
    }
  }, [_vm._v(_vm._s(_vm.$t('DeviceName')))])]), _c('th', [_c('span', [_vm._v(_vm._s(_vm.$t('AssignedReader')))])]), _c('th', {
    staticClass: "text-center"
  }, [_c('span', [_vm._v(_vm._s(_vm.$t('TotalItems')))])]), _c('th', {
    staticClass: "text-center"
  }, [_c('span', [_vm._v(_vm._s(_vm.$t('Status')))])])])]), _c('tbody', [_vm._l(_vm.GroupData, function (item, index) {
    return _c('tr', {
      key: index
    }, [_c('td', {
      staticClass: "text-center"
    }, [item.group_id != null ? _c('input', {
      staticClass: "chkItems",
      attrs: {
        "type": "checkbox"
      },
      ...
      on: {
        "click": function ($event) {
          return _vm.editNewGroup(item.group_id);
        }
      }
    }, [_c('span', {
    ...
    }, [_vm._v(_vm._s(item.group_name))])])]), _c('td', [_c('span', {
      staticClass: "text-overflow-dynamic-container"
    }, [_vm._v(_vm._s(item.group_details))])]), _c('td', [_c('span', {
      staticClass: "text-overflow-dynamic-container"
    }, [_vm._v(_vm._s(item.device_name))])]), _c('td', [_c('span', {
      staticClass: "text-overflow-dynamic-container"
    }, [_vm._v(_vm._s(item.item_description))])]), _c('td', {
    ...
    }, [_vm._v(_vm._s(item.TotalItemsCount))])])]), _c('td', [_c('div', {
      ...
      directives: [{
        ...
        expression: "item.STATUS_ID"
      }],
      class: {
        'ddlupdatestatus w-80 btn-success': item.STATUS_ID == 1001,
        'ddlupdatestatus w-80 btn-danger': item.STATUS_ID == 1002
      },
      on: {
        "change": [function ($event) {
          var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
          ...
          _vm.$set(item, "STATUS_ID", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
        }, function ($event) {
          return _vm.UpdataStatus(item.STATUS_ID, item.group_id);
        }]
      }
    }, _vm._l(_vm.StatusData, function (items, index) {
      return _c('option', {
        key: index,
        domProps: {
...
// CONCATENATED MODULE: ./src/views/ItemGroupList/List.vue?vue&type=template&id=217ac64c&
...
/* harmony default export */ var Listvue_type_script_lang_js_ = ({
  ...
  methods: {
    GetGroupList: function () {
      var url = `search=${this.txtsearch}&statusIds=${this.statusIds}&pageSize=${this.PageSize}&pageNum=${this.PageNumber}&sortBy=${this.sortBy}&sortExp=${this.sortExp}&IsDefault=${this.IsDefault}`;
      var vueObj = this;
    ...
    getStatuslistForListing: function (StatusType, lang) {
      ...
      DataService["a" /* default */].statusdropdown(url).then(function (response) {
    ...
    UpdataStatus(statusId, gropid) {
      ...
      DataService["a" /* default */].CommonUpdateStatus(PostString).then(function (response) {
        if (response.data != null) {
          if (response.data.status === 'Success') {
    ...
    onChange: function () {
      var checkCount = $('.chkItems:checked').not("[id^='chkAll']").length;
      if (checkCount > 0) {
        $('#DeleteAssetCatalogue').removeClass('disabled');
      } else {
        $('#DeleteAssetCatalogue').addClass('disabled');
      }
    }
  }
});
